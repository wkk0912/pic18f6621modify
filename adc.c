...
void adc_init(void)
{
    ...
    ACQT0 = 1;//采样保持时间为20tad
    ACQT1 = 1;
    ACQT2 = 1;

    ADCS0 = 0;//20mhz 时间设置为3.2us
    ADCS1 = 1;
    ADCS2 = 1;
    ...
    TRISF2 = 0;//电流电压检测 地址线 0
    TRISF3 = 0;//电流电压检测 地址线 1
...
void capture_init(void)
{
    ...
    CCP4CON = 0x04;//0x04下降沿捕捉0x05上升沿捕捉RG3
    CCP5CON = 0X05;//0x04下降沿捕捉0x05上升沿捕捉RG4
...
void ad_sequence_sample(void)
{
    ...
    case 2:/*由time1的5ms定时中断处理，这里不用处理*/	
    	adm.idle_time=0;           
        break;
